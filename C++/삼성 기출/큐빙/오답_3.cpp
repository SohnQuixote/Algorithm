...
{   
      if(cmd.first == 0) //위
      {
        vector<int> surf_three,surf_five,surf_two,surf_four;
        surf_three = c[3][0];
        surf_five = c[5][0];
        surf_two = c[2][0];
        surf_four = c[4][0];
        ...
        {//시계
          ...
          for(int i=0;i<3;i++)
            {
              c[3][0][i] = surf_four[2-i];
              
            }
          
          for(int i=0;i<3;i++)
            {
              c[5][0][i] = surf_three[2-i];
      ...
      else if(cmd.first == 1) //아래
      {
        ...
        {//시계
          ...
          for(int i=0;i<3;i++)
            {
              c[3][2][i] = surf_four[2-i];
              
            }
          
          for(int i=0;i<3;i++)
            {
              c[5][2][i] = surf_three[2-i];
