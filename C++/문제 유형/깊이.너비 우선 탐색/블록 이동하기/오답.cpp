    ...
    while(!q.empty())
    {
        ...
        if(state == 0) //가로에서 세로
        {
            ...
            else//위 90도
            {
                ...
                if(calc_range(mov_x_one,N) && calc_range(mov_y_one,N) && calc_range(mov_x_two,N) && calc_range(mov_y_two,N) && board[mov_x_one][mov_y_one] != 1 && board[mov_x_two][mov_y_two] != 1 && visited[mov_x_one][mov_y_one][mov_x_two][mov_y_two][1] == false)
        ...
        else //세로에서 가로
        {
            for(int i=0;i<2;i++)
            {
                ...
                else //우 90
                {
                    ...
                    mov_y_two = y_one + rot_one_dx_ver[i];
                }
                if(calc_range(mov_x_one,N) && calc_range(mov_y_one,N) && calc_range(mov_x_two,N) && calc_range(mov_y_two,N) && board[mov_x_one][mov_y_one] != 1 && board[mov_x_two][mov_y_two] != 1 && visited[mov_x_one][mov_y_one][mov_x_two][mov_y_two][0] == false)
