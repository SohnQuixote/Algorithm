...
void print_adj_rank(vector<int> graphs[], vector<int> ranks, vector<int> degrees)
{
  //위상 정렬 잘됨
  int N = ranks.size();
  ...
  for(int te=0;te<T;te++)
    {
      ...
      print_adj_rank(graphs,ranks,degrees);
      ranks.clear();
